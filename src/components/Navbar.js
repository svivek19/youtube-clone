...
const Navbar = () => {
  ...
  return (
    <div className='bg-black h-14 flex items-center pl-4 pr-5 md:justify-between fixed w-full z-10'>
      ...
      <div className='h-10 flex flex-row items-center'>
        <div className='w-full md:w-[594px] bg-black hidden md:block lg:flex md:border md:border-slate-900 items-center rounded-3xl h-10'>
      ...
      <div className='flex items-center nav-img md:mx-0 justify-center'>
        <div className='flex flex-row items-center'>
          ...
          <div className='items-center mx-0 cursor-pointer'>
            {
              !user ? (
